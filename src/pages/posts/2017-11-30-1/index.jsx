...
let Typex = require("./photo_2018-01-07_20-34-02.jpg");

let metadata = {
  id: "2017-11-30-1",
  author: "Boris Burkov",
  authors_avatar: require("images/burkov_boris_web.jpg"),
  date_created: "30.11.2017",
  language: "ru",
  title: "Энигма, часть 5",
  subtitle: "\"Бисмарк\" и \"дебютантка\"",
  abstract: "В ходе \"Битвы за Атлантику\" в 41-ом году немецкий флот пытался отрезать Великобританию от " +
    "морского сообщения с континентом и Штатами. У немцев было превосходство в военно-морском флоте, и на какое-то время " +
    "им даже удалось установить вокруг островов морскую блокаду.",
  cover: "http://www.telegraph.co.uk/content/dam/obituaries/2016/05/25/53787438__Jane-Fawcett-young-OBITS_trans_NvBQzQNjv4BqhJpcTaDycYqZzDAOAUJ79c9dYnr0ptv4PRBB4Y-i9ow.jpg?imwidth=480",
