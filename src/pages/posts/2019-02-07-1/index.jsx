  ...
  render() {
    return (
      <div>
        ...
        <p>
          После 10 лет стагнации, на CASP'10 в 2012 был достигнут большой прогресс: люди додумались использовать данные
          о коэволюции аминокислот. Например, если в человеческой версии белка в одном месте последовательности была
