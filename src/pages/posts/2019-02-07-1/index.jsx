...
let birneyAndSenior = require('./2019-02-08 10.15.17.jpg');
let pipeline = require('./2019-02-08 10.14.16.jpg');
let neuralNetwork = require('./IMAGE 2019-02-08 22:18:23.jpg');
let dataset = require('./IMAGE 2019-02-08 22:18:27.jpg');
let distograms = require('./IMAGE 2019-02-08 22:17:05.jpg');
...
let metadata = {
  ...
  "теперь пытаются осознать, 'что это было': революция или эволюция, наука или инженерия, " +
    ...
    return (
      <div>
        ...
        <p>
          ...
          (например, "MAKFGEWTTPFTNS" - всего 20 разных бывает). Прочитать последовательность белка очень дешево,
          но расшифровать 3D-структуру белка (как та, что на обложке этой статьи) крайне дорого и трудоемко. Но именно
          3D-структура содержит ценную информацию для синтеза новых лекарств - например, по ней можно подобрать
          вещества, которые связываются с этим белком и подавляют его функцию - такие вещества могут стать новыми
          лекарствами.
        </p>
        <p>
        ...
        <p>
          После 10 лет стагнации, на CASP'10 был достигнут большой прогресс: люди додумались использовать данные о
          коэволюции аминокислот. Например, если в человеческой версии белка в одном месте последовательности была
          положительно заряженная аминокислота, а в другом - отрицательно, а у аналогичного белка из обезьяны - наоборот,
          то можно предположить, что эти аминокислоты неспроста так коэволюционируют.
        </p>
        <img src="http://mistic.leloir.org.ar/docs/MIexplained.png" className="img-responsive center-block" />
        <div className="caption text-center">
          Последовательности семейства однотипных белков из разных видов записаны в строках. Видно, что в
          тех видах, где четвертая аминокислота изменилась, изменилась и восьмая.
        </div>
        <p>
          ...
          не выходит. Поэтому, народ стал просто "зачерпывать" ДНК из окружающей среды и секвенировать - и там оказалось
          гораздо больше разнообразия. Сергей Овчинников из Гарварда придумал, что это разнообразие можно использовать и
          для получения данных о коэволюции - и предсказания удалось улучшить еще больше.
        </p>
        <p>
        ...
        <h2>Как все было?</h2>
        <p>
          Все началось как хакатон. Сотрудники DeepMind пообщались со структурным биоинформатиком и соавтором
          системы классификации пространственных доменов CATH <a href="https://www.crick.ac.uk/research/labs/david-jones">Дэвидом Джонсом</a>
          из Crick Institute при University College London (там в свое время переучивался на машиниста Демис Хассабис).
          Тот объяснил им, как устроен современный биоинформатический пайплайн предсказания 3D-структур белков. Один из
          сотрудников DeepMind для интереса попробовал за выходные запустить предсказание 3D-структуры белка, и добился
        ...
        <p>
          Это была абсолютно титаническая, блесятщая инженерная работа. Они практически не коснулись биологии совсем,
          ...
          эволюция и преимущественно не наука, а виртуозная инженерия.
        </p>
        <p>
          В соавторах статьи человек 15, по-видимому, основной вклад внесли шестеро. Сам Эндрю Сеньор занимался
