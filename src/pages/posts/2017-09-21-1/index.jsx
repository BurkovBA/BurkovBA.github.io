    ...
    return (
      <div>
        <p>
          ...
          Выступали двое из пяти (!) её основателей: Ник Ленч и Энди Ричардс, и самое мощное впечатление произвёл Ричардс, с которым я после этого побеседовал.
        </p>
        ...
        <ul>
          ...
          <li> Фил Билс был человеком со стороны медицины, имевшим контакты с врачами</li>
