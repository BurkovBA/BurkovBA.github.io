...
Самая очевидная поверхность атаки - это "мертвые души". При поверхностном ознакомлении с публичными данными, я не увидел явных противоречий. 
...
Что касается затрат времени, [ссылаюсь на Петра Жижина](https://habr.com/ru/post/579350/), он расшифровывал транзакции в 24 процесса на обычном сервере, и все посчиталось за полчаса, результаты для тех 1.3 миллионов транзакций, которые все-таки были расшифрованы в SQL-дампе - сошлись.

То есть на технику 14 часов уйти не могло.

Может ли блокчейн в каком-то виде хранить данные о переголосовавших? Как понять, кто переголосовал, в общем блокчейне?
----------------------------------------------------------------------------------------------------------------------

Невозможно ничего понять. По публичному блокчейну невозможно отличить переголосование от первичного голосования.

Эти данные можно получить только из приватного блокчейна, так называемого БЧ-2, но его данные широкой публике не предоставляются.
...
Другие типы транзакций несут другую информацию. С точки зрения анализа итогов голосования интересен прежде всего шестой тип транзакций - "Прием бюллетеня" - таких транзакций всего 2 021 969 штук.
