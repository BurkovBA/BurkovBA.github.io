...
let metadata = {
  ...
  subtitle: "",
  abstract: "After taking a break from DevOps for a few months and switching to other fields," +
  " I would always forget the details of how users within a docker container map to users on the host machine." +
  " This is a condensed recap of user mappings that should save me time, upon switching the contexts.",
  cover: "https://cdn-images-1.medium.com/max/640/1*TdHKA_vurEsoQVvaENRtBg.png",
